...
<!-- Todo: add a link to the grade calculator and revamp that -->
...
<table cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%;">
    ...
    <tbody>
        ...
        <tr class="even-row">
            <td rowspan="1">Lab 2 – Routers & Firewall</td>
        </tr>
        <tr class="even-row">
            <td rowspan="1">Lab 3 – SSH & FTP</td>
        </tr>
        <tr class="even-row">
            <td rowspan="1">Lab 4 – Database Servers</td>
        </tr>
        <tr class="even-row">
            <td rowspan="1">Lab 5 – Web Servers</td>
        </tr>
        <tr class="even-row">
            <td rowspan="1">Lab 6 – DNS</td>
        </tr>
        <tr class="even-row">
            <td rowspan="1">Lab 7 – Backups</td>
        </tr>
        <tr class="even-row">
            <td rowspan="1">Lab 8 – Hardening & Threat Hunting</td>
        </tr>
        <tr class="even-row">
            <td rowspan="1">Lab 9 – SIEM</td>
        </tr>
        <tr class="even-row">
